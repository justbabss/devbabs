...
function App() {
  ...
  return (
    <>
      <section className={`${darkMode ? 'bg-black' : 'bg-white'} text-${darkMode ? 'white' : 'black'} w-full scroll-smooth h-screen overflow-auto px-5 pt-5 sm:px-3 sm:py-5 md:overflow-hidden`}>
